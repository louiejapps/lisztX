...
function loadThoughts() {
	...
	let messageHashMap = {
		...
		Fenimaure: { image: profileHashMap['Fenimaure'], shoutout: '達成 gets it' },
		ZzenN: { image: profileHashMap['ZzenN'], shoutout: 'Magic lies in the mind' },
		Pennyclied30: { image: profileHashMap['Pennyclied30'], shoutout: '😁😁' },
		Jolyows: { image: profileHashMap['Jolyows'], shoutout: '😍😋' },
		XtreamCH: { image: profileHashMap['XtreamCH'], shoutout: '🙄😯' },
		ZzzChizCurlzzZ: { image: profileHashMap['ZzzChizCurlzzZ'], shoutout: '' },
		JellyMuse: { image: profileHashMap['JellyMuse'], shoutout: '' },
		lystar: { image: profileHashMap['lystar'], shoutout: '' },
		sevenEvelyn: { image: profileHashMap['sevenEvelyn'], shoutout: 'To the hidden blade, all life is equal.' },
		Bradford: { image: profileHashMap['Bradford'], shoutout: '' },
		Metsuki: { image: profileHashMap['Metsuki'], shoutout: '' },
		mjba4w: { image: profileHashMap['mjba4w'], shoutout: 'rank' },
